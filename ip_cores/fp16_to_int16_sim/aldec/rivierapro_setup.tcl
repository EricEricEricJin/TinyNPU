...
# ACDS 23.1 993 linux 2025.03.22.14:39:57
# ----------------------------------------
...
# ----------------------------------------
# If fp16_to_int16 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp16_to_int16"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp16_to_int16.vo"
}
