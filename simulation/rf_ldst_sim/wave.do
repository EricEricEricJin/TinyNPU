...
add wave -noupdate /rf_ldst_tb/i_rf_ldst_intf/rf_addr_freeze
add wave -noupdate -divider {New Divider}
...
add wave -noupdate /rf_ldst_tb/i_rf_ldst/rf_addr_freeze
...
WaveRestoreCursors {{Cursor 1} {1754727 ps} 0}
...
update
WaveRestoreZoom {1733986 ps} {1794719 ps}
