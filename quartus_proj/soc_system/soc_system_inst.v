	soc_system u0 (
		.avmm_sdram_read_wrapper_0_read_read_start (<connected-to-avmm_sdram_read_wrapper_0_read_read_start>), // avmm_sdram_read_wrapper_0_read.read_start
		.avmm_sdram_read_wrapper_0_read_read_cnt   (<connected-to-avmm_sdram_read_wrapper_0_read_read_cnt>),   //                               .read_cnt
		.avmm_sdram_read_wrapper_0_read_read_data  (<connected-to-avmm_sdram_read_wrapper_0_read_read_data>),  //                               .read_data
		.avmm_sdram_read_wrapper_0_read_read_addr  (<connected-to-avmm_sdram_read_wrapper_0_read_read_addr>),  //                               .read_addr
		.avmm_sdram_read_wrapper_0_read_read_done  (<connected-to-avmm_sdram_read_wrapper_0_read_read_done>),  //                               .read_done
		.avmm_sdram_read_wrapper_0_read_read_valid (<connected-to-avmm_sdram_read_wrapper_0_read_read_valid>), //                               .read_valid
