...
# Sun Mar 30 23:39:11 HKT 2025
# DO NOT MODIFY


# 
# avmm_sdram_wrapper "Avalon MM SDRAM Wrapper" v1.0
# jyseric 2025.03.30.23:39:11
# 
# 
...
set_module_property NAME avmm_sdram_wrapper
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR jyseric
set_module_property DISPLAY_NAME "Avalon MM SDRAM Wrapper"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL avmm_sdram_wrapper
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file avmm_sdram_wrapper.sv SYSTEM_VERILOG PATH ../design_rtl/io/avmm_sdram_wrapper.sv TOP_LEVEL_FILE
...
add_interface_port m0 writedata writedata Output "((SDRAM_DATA_W-1)) - (0) + 1"
add_interface_port m0 byteenable byteenable Output 16
...
set_interface_property rw associatedReset reset
...
add_interface_port rw rw_cnt rw_cnt Input 11
add_interface_port rw rw_done rw_done Output 1
add_interface_port rw rw_addr rw_addr Input 32
...
add_interface_port write write_data write_data Input "((SDRAM_DATA_W-1)) - (0) + 1"
add_interface_port write write_nxt write_nxt Output 1
add_interface_port write write_start write_start Input 1
